...
class _$Promo extends Promo {
  ...
  _$Promo._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(title, 'Promo', 'title');
    BuiltValueNullFieldError.checkNotNull(imageUrl, 'Promo', 'imageUrl');
    BuiltValueNullFieldError.checkNotNull(videoUrl, 'Promo', 'videoUrl');
  }
