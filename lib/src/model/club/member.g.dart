...
class _$Member extends Member {
  ...
  _$Member._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(username, 'Member', 'username');
    BuiltValueNullFieldError.checkNotNull(url, 'Member', 'url');
    BuiltValueNullFieldError.checkNotNull(imageUrl, 'Member', 'imageUrl');
  }
  ...
  _$Member build() {
    final _$result = _$v ??
        new _$Member._(
            ...
            url: BuiltValueNullFieldError.checkNotNull(url, 'Member', 'url'),
